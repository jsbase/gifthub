...
const GiftCard: React.FC<GiftCardProps> = ({
  ...
  const wrapperProps = gift.url
    ? {
        ...
        className: cn('p-4 pb-2 mt-1', 'border-b', 'block'),
      }
    : {
        className: cn('p-4 pb-2 mt-1', 'border-b', 'block'),
      };
    ...
    >
      ...
      <div className={cn('flex flex-row space-x-2')}>
        <Button
          ...
          className={cn(
            'flex-1 text-red-600 hover:text-red-700 border-r rounded-none'
          )}
        ...
        <Button
          ...
          className={cn(
            'flex-1 transition-transform duration-300 ease-in-out rounded-none'
          )}
